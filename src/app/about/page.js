  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-red-500/20 antialiased font-sans flex flex-col relative overflow-hidden">
      ...
      <header className="border-b border-white/10 bg-white/95 backdrop-blur-md sticky top-0 z-50 px-4 sm:px-6 md:px-12 py-4 flex justify-between items-center max-w-7xl mx-auto w-full text-black">
        ...
        >
          <span className={`block w-6 h-0.5 bg-black transition-transform duration-300 ${mobileMenuOpen ? 'transform rotate-45 translate-y-2' : ''}`}></span>
          <span className={`block w-6 h-0.5 bg-black transition-opacity duration-300 ${mobileMenuOpen ? 'opacity-0' : ''}`}></span>
          <span className={`block w-6 h-0.5 bg-black transition-transform duration-300 ${mobileMenuOpen ? 'transform -rotate-45 -translate-y-2' : ''}`}></span>
        </button>

        {/* Floating Mobile Dropdown Context */}
        {mobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-white border-b border-black/10 flex flex-col p-6 space-y-4 md:hidden shadow-xl animate-slide-up z-50">
            <Link href="/" onClick={() => setMobileMenuOpen(false)} className="text-sm font-bold uppercase tracking-wider text-slate-600 hover:text-blue-600">Home</Link>
            <Link href="/programs" onClick={() => setMobileMenuOpen(false)} className="text-sm font-bold uppercase tracking-wider text-slate-600 hover:text-blue-600">Programs</Link>
            <Link href="/about" onClick={() => setMobileMenuOpen(false)} className="text-sm font-bold uppercase tracking-wider text-black border-l-2 border-blue-600 pl-2">About</Link>
            <Link href="/contact" onClick={() => setMobileMenuOpen(false)} className="text-sm font-bold uppercase tracking-wider text-slate-600 hover:text-blue-600">Contact</Link>
            <hr className="border-slate-200 sm:hidden" />
            <div className="flex flex-col space-y-3 sm:hidden pt-2">
              <Link href="/login" onClick={() => setMobileMenuOpen(false)} className="text-sm font-bold text-slate-600 text-center py-2">Sign In</Link>
              <Link href="/signup" onClick={() => setMobileMenuOpen(false)} className="rounded-none bg-black px-6 py-3 text-sm font-bold text-white text-center hover:bg-red-600 transition-colors">Get Started</Link>
            </div>
          </div>
        )}
      </header>
      ...
      {/* Main Container */}
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-10 md:py-20 flex flex-col space-y-16 md:space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center animate-slide-up">
          <div className="lg:col-span-7 space-y-4 md:space-y-6 text-left">
            ...
            <div className="pt-2 flex flex-col sm:flex-row gap-4">
              <Link href="/signup" className="rounded-none bg-red-600 px-6 md:px-8 py-3.5 md:py-4 font-bold uppercase tracking-widest text-white text-xs hover:bg-white hover:text-black transition-all duration-300 text-center">
                Join Our Next Cohort
              </Link>
              <a href="#vision" className="rounded-none border border-white/20 px-6 md:px-8 py-3.5 md:py-4 font-bold uppercase tracking-widest text-white text-xs hover:bg-white/10 transition-all duration-300 text-center">
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0">
            <div className="border border-white/10 p-2 bg-white/5 backdrop-blur-md">
              <img 
                ...
                className="w-full h-[240px] sm:h-[350px] object-cover grayscale hover:grayscale-0 transition-all duration-500"
              />
            </div>
            <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-blue-600 text-white p-4 sm:p-6 border border-black max-w-[180px] sm:max-w-[240px] text-left">
              <span className="text-2xl sm:text-3xl font-black block leading-none">50K+</span>
              <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-blue-200 mt-1 block">Five-Year Student Goal</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <div 
            className="scroll-card border border-white/10 bg-white/[0.01] p-6 sm:p-8 space-y-6 text-left relative overflow-hidden group hover:border-blue-500/40 hover:-translate-y-1 hover:shadow-[0_4px_30px_rgba(59,130,246,0.1)] transition-all duration-500 flex flex-col justify-between"
            style={{ '--delay': '0ms' }}
          >
            <div className="space-y-4">
              <div className="absolute top-0 left-0 w-1 h-full bg-blue-500" />
              <span className="text-xs font-black tracking-widest text-blue-400 uppercase">Strategic Intent</span>
              <h2 className="text-xl sm:text-2xl font-black text-white uppercase tracking-tight">Our Vision</h2>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
                To become Africa's premier online institution for technology, design, and digital innovation education.
              </p>
            </div>
            <div className="h-36 sm:h-48 w-full overflow-hidden border border-white/5 mt-4">
              <img 
          ...
          <div 
            className="scroll-card border border-white/10 bg-white/[0.01] p-6 sm:p-8 space-y-6 text-left relative overflow-hidden group hover:border-red-500/40 hover:-translate-y-1 hover:shadow-[0_4px_30px_rgba(239,68,68,0.1)] transition-all duration-500 flex flex-col justify-between"
            style={{ '--delay': '150ms' }}
          >
            <div className="space-y-4">
              <div className="absolute top-0 left-0 w-1 h-full bg-red-500" />
              <span className="text-xs font-black tracking-widest text-red-400 uppercase">Operational Purpose</span>
              <h2 className="text-xl sm:text-2xl font-black text-white uppercase tracking-tight">Our Mission</h2>
              <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
        ...
        <section className="space-y-6 md:space-y-8 text-left">
          <div className="max-w-2xl animate-slide-up">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white uppercase tracking-tight mt-1">Breaking Traditional Barriers</h2>
          ...
          <div className="flex border-b border-white/10 animate-slide-up overflow-x-auto no-scrollbar whitespace-nowrap">
            <button 
              onClick={() => setActiveTab('pillars')}
              className={`pb-4 text-xs font-bold uppercase tracking-widest border-b-2 mr-6 sm:mr-8 transition-colors flex-shrink-0 ${activeTab === 'pillars' ? 'border-red-500 text-white' : 'border-transparent text-slate-400 hover:text-white'}`}
            >
              Our Practical Priorities
            </button>
            <button 
              onClick={() => setActiveTab('challenges')}
              className={`pb-4 text-xs font-bold uppercase tracking-widest border-b-2 transition-colors flex-shrink-0 ${activeTab === 'challenges' ? 'border-red-500 text-white' : 'border-transparent text-slate-400 hover:text-white'}`}
            >
          ...
          {activeTab === 'pillars' ? (
            <div key="pillars-grid" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {[
                ...
                <div 
                  ...
                  className="scroll-card border border-white/10 bg-white/[0.02] p-5 sm:p-6 space-y-3 flex flex-col justify-between group hover:border-red-500/30 hover:-translate-y-1.5 hover:shadow-[0_4px_25px_rgba(239,68,68,0.08)] transition-all duration-500"
                >
                  <div className="space-y-2">
                    <span className="text-[10px] font-bold text-red-500">PRIORITY 0{idx+1}</span>
                    <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-tight">{pillar.title}</h3>
            ...
            <div key="challenges-grid" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                <div 
                  key={idx} 
                  style={{ '--delay': `${idx * 100}ms` }}
                  className="scroll-card border border-white/10 bg-white/[0.02] p-5 sm:p-6 space-y-3 border-l-2 border-l-amber-500 flex flex-col justify-between group hover:border-amber-500/30 hover:-translate-y-1.5 hover:shadow-[0_4px_25px_rgba(245,158,11,0.08)] transition-all duration-500"
                >
                  <div className="space-y-2">
                    <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-tight">{challenge.issue}</h3>
                    <p className="text-[11px] sm:text-xs text-slate-400 leading-relaxed">{challenge.detail}</p>
                  </div>
        ...
        <section className="space-y-6 md:space-y-8 text-left">
          <div className="max-w-2xl animate-slide-up">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-white uppercase tracking-tight mt-1">Our Hybrid Learning Model</h2>
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed mt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div 
                key={idx} 
                style={{ '--delay': `${idx * 100}ms` }}
                className="scroll-card border border-white/5 bg-white/[0.01] p-5 sm:p-6 space-y-3 relative group hover:border-blue-500/30 hover:-translate-y-1.5 hover:shadow-[0_4px_25px_rgba(59,130,246,0.08)] transition-all duration-500 flex flex-col justify-between"
              >
                <div>
                  <span className="text-2xl sm:text-3xl font-black text-white/10 absolute right-4 top-4 group-hover:text-blue-500/10 transition-colors duration-500">01</span>
                  <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-tight">{model.type}</h3>
                  <p className="text-[11px] sm:text-xs text-slate-400 leading-relaxed mt-2">{model.desc}</p>
                </div>
                <div className="h-24 w-full overflow-hidden border border-white/5 mt-4">
                  <img 
                    src={model.img} 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-stretch">
          ...
          <div 
            style={{ '--delay': '0ms' }}
            className="scroll-card lg:col-span-6 border border-white/10 bg-gradient-to-br from-blue-900/10 to-transparent p-6 sm:p-8 text-left flex flex-col justify-between space-y-6 group hover:border-blue-500/30 hover:-translate-y-1 hover:shadow-[0_4px_30px_rgba(59,130,246,0.1)] transition-all duration-500"
          >
            <div className="space-y-4">
              <span className="text-xs font-bold text-blue-400 tracking-widest uppercase">Product Incubator</span>
              <h3 className="text-xl sm:text-2xl font-black text-white uppercase">Ornate Innovation Hub</h3>
            ...
            <div className="h-36 sm:h-40 w-full overflow-hidden border border-white/5">
              <img 
          ...
          <div 
            style={{ '--delay': '150ms' }}
            className="scroll-card lg:col-span-6 border border-white/10 bg-gradient-to-br from-red-900/10 to-transparent p-6 sm:p-8 text-left flex flex-col justify-between space-y-6 group hover:border-red-500/30 hover:-translate-y-1 hover:shadow-[0_4px_30px_rgba(239,68,68,0.1)] transition-all duration-500"
          >
            <div className="space-y-4">
              <span className="text-xs font-bold text-red-500 tracking-widest uppercase">Career Accelerator</span>
              <h3 className="text-xl sm:text-2xl font-black text-white uppercase">Ornate Career Center</h3>
              <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <section className="pt-12 sm:pt-16 border-t border-white/10 space-y-10 md:space-y-12 text-left">
          <div className="max-w-2xl animate-slide-up">
            <span className="text-xs font-bold text-amber-500 tracking-widest uppercase">Strategic Vision</span>
            <h2 className="text-2xl sm:text-3xl font-black text-white uppercase tracking-tight mt-1">Our Five-Year Road Map</h2>
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed mt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div 
                key={idx} 
                style={{ '--delay': `${idx * 100}ms` }}
                className="scroll-card border border-white/10 bg-white/[0.01] p-5 sm:p-6 space-y-3 relative overflow-hidden group hover:border-red-500/30 hover:-translate-y-1.5 hover:shadow-[0_4px_25px_rgba(239,68,68,0.08)] transition-all duration-500 flex flex-col justify-between"
              >
                <div>
                  <div className="w-12 h-0.5 bg-red-500 mb-4 group-hover:w-20 transition-all duration-500" />
                  <h3 className="text-xl sm:text-2xl font-black text-white tracking-tight leading-none">{goal.stat}</h3>
                  <h4 className="text-[10px] sm:text-xs font-bold text-slate-300 uppercase tracking-tight mt-1">{goal.label}</h4>
                  <p className="text-[11px] sm:text-xs text-slate-400 leading-relaxed mt-2">{goal.desc}</p>
                </div>
